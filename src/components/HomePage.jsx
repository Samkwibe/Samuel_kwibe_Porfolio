...
export default function Hero() {
  ...
  const techStack = [
    { name: 'REACT/NEXT.JS', level: 60, color: '#00f5ff' },
    { name: 'PYTHON/AI', level: 55.9, color: '#00ff88' },
    { name: 'AWS CLOUD', level: 25, color: '#ff0088' },
    { name: 'NODE.JS', level: 50, color: '#ffaa00' },
  ]

  const systemMetrics = [
    { label: 'SYSTEM LOAD', value: '80%', color: '#00f5ff' },
    { label: 'CODE EFFICIENCY', value: '87%', color: '#00ff88' },
    { label: 'CLOUD READY', value: '25%', color: '#ff0088' },
    { label: 'AI INTEGRATION', value: '45%', color: '#ffaa00' }
  ]
